...
Agile is a word used to characterize software development methodologies that emphasize incremental delivery, team cooperation, continuous planning, and continuous learning rather than attempting to provide it all at once towards the end.

Agile emphasizes lean processes and the creation of minimal viable products (MVPs) that go through numerous iterations before being finalized. Feedback is constantly received and applied, resulting in a much more dynamic process in which everyone is working towards a common objective.


Scrum is a methodology for addressing complex adaptive challenges while producing high-value solutions in a productive and creative manner. It is used to manage software projects and the creation of new products or applications. It focuses on an adaptable product development technique in which a cross-functional team works together to achieve a common goal in 2-4 weeks (Sprint).
